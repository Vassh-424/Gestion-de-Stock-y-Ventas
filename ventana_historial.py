...
def historial(): 
    ...
    def buscar_por_fecha():
        ...
        resultados = db.buscar_ventas_por_fecha(dia=dia, mes=mes, anio=anio)
    ...
    def mostrar_ventas(query=None):
        ...
        resultados = db.buscar_ventas_por_fecha()  # Llama al método para obtener todas las ventas
        if resultados:
            ...
            for idx, venta in enumerate(resultados, 1):
